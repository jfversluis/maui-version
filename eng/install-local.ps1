...
if ($Uninstall) {
    Write-Host "Uninstalling mauiversion..." -ForegroundColor Yellow
    dotnet tool uninstall -g mauiversion 2>&1 | Out-Null
    Write-Host "✓ Uninstalled mauiversion" -ForegroundColor Green
    exit 0
}
